...
@section('page_title', 'Manage Subpage')
@section('container')
<div class="page-title">
    <div class="title_left">
        <h3>Manage Subpage</h3>
        <a href="{{url('admin/sub_page')}}"><button class="btn btn-primary btn-sm"><i class="fas fa-backward"></i>&nbsp;&nbsp;BACK</button></a>
        <hr>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 ">
        <form class="form-horizontal form-label-left" method="post" action="{{route('sub_page.manage_sub_page_process')}}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="x_content">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="col-md-12 col-sm-12">
                                        <label for="">Page Banner Image</label>
                                        <input type="file" name="og_image" class="form-control">
                                        @error('og_image')
                                            <span class="text-danger" style="font-size: 16px">{{$message}}</span>
                                        @enderror
                                        @if ($og_image != '')
                                            <img width="100px" class="mt-3" src="{{asset('storage/media/subpage/'.$og_image)}}" alt="">
                                        @endif
                                    </div>
                                </div>
                            </div>
