...
@section('page_title', 'Dr. Siladitya Ray | services');

@section('container')
<div class="about-ban">
    <img src="{{asset('front_assets/images/img8.jpg')}}">
</div>
<div class="service-cont">
    <div class="text-font-two">
    <h2>Clinical</h2>
    <div class="comonaccordian">
        ...
        <div class="accordion md-accordion accordion-2" id="accordionEx7" role="tablist"
            ...
            <!-- Card header -->
            <div class="card-header rgba-stylish-strong z-depth-1 mb-1 tab-color" role="tab" id="heading1">
            ...
            <!-- Card header -->
            <div class="card-header rgba-stylish-strong z-depth-1 mb-1 tab-color" role="tab" id="heading2">
            ...
            <!-- Card header -->
            <div class="card-header rgba-stylish-strong z-depth-1 mb-1 tab-color" role="tab" id="heading3">
